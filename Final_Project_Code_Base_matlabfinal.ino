...
const int NUM_SAMPLES = 5999;  // 3600; use 4999 for sweep, 1199 for breathingdata, 2399 for breathingdata2 and 3 
...
// for reading data from the sensor use 
